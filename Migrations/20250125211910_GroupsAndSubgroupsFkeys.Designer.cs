...
namespace WebApiTemplate.Migrations
{
    ...
    [Migration("20250125211910_GroupsAndSubgroupsFkeys")]
    partial class GroupsAndSubgroupsFkeys
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApiTemplate.Models.ContentFile", b =>
                {
                    b.HasOne("WebApiTemplate.Models.Group", "Group")
                        .WithMany("ContentFiles")
                        .HasForeignKey("GroupId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebApiTemplate.Models.Subgroup", "Subgroup")
                        .WithMany("ContentFiles")
